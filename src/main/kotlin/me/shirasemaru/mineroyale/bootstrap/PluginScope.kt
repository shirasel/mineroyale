...
class PluginScope private constructor(
    ...
    companion object {
        fun create(plugin: Mineroyale): PluginScope {
            ...
            val scoreboardProvider = BukkitScoreboardProvider()
            ...
            val scoreboardManager = BukkitScoreboardFactory(onlinePlayerProvider, scoreboardProvider).create()
            val playerRegistry = PlayerRegistry()
            val playerSetupService = PlayerSetupService(configManager, onlinePlayerProvider, scoreboardProvider)
